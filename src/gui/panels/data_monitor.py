...
class DataMonitor(QWidget):
    ...
    def update_data(self):
        ...
        for i in range(10):
            ...
            status_item.setForeground(Qt.green if status == "OK" else Qt.red)
...
class SimpleDataMonitor(QWidget):
    ...
    def setup_ui(self):
        ...
        self.flow_label.setStyleSheet("font-size: 16px;")
    ...
    def update_data(self):
        ...
        self.status_label.setStyleSheet(
            "font-size: 12px; color: green;" if status == "OK" else "font-size: 12px; color: red;"
        )